...
RESOURCES += src/qt/KONA.qrc src/qt/KONA_locale.qrc

TRANSLATIONS += src/qt/locale/KONA_bg.ts \
                src/qt/locale/KONA_de.ts \
                src/qt/locale/KONA_en.ts \
                src/qt/locale/KONA_es.ts \
                src/qt/locale/KONA_fi.ts \
                src/qt/locale/KONA_fr.ts \
                src/qt/locale/KONA_it.ts \
                src/qt/locale/KONA_ja.ts \
                src/qt/locale/KONA_pl.ts \
                src/qt/locale/KONA_pt.ts \
                src/qt/locale/KONA_ru.ts \
                src/qt/locale/KONA_sk.ts \
                src/qt/locale/KONA_sv.ts \
                src/qt/locale/KONA_vi.ts \
                src/qt/locale/KONA_zh_CN.ts \
                src/qt/locale/KONA_zh_TW.ts
