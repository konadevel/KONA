                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("KONA Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KONA address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and KONA: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKONA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KONA Core"), this);
    aboutAction->setStatusTip(tr("Show information about KONA Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KONA"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KONA addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KONA addresses"));
    ...
    openAction->setStatusTip(tr("Open a KONA: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KONA Core help message to get a list with possible KONA command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("KONA Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KONA network", "", count));
}
...
{
    QString strTitle = tr("KONA Core"); // default title
