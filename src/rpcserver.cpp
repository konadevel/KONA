...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* KONA features */
        {"KONA", "masternode", &masternode, true, true, false},
        {"KONA", "listmasternodes", &listmasternodes, true, true, false},
        {"KONA", "getmasternodecount", &getmasternodecount, true, true, false},
        {"KONA", "masternodeconnect", &masternodeconnect, true, true, false},
        {"KONA", "masternodecurrent", &masternodecurrent, true, true, false},
        {"KONA", "masternodedebug", &masternodedebug, true, true, false},
        {"KONA", "startmasternode", &startmasternode, true, true, false},
        {"KONA", "createmasternodekey", &createmasternodekey, true, true, false},
        {"KONA", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"KONA", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"KONA", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"KONA", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"KONA", "getmasternodescores", &getmasternodescores, true, true, false},
        {"KONA", "mnbudget", &mnbudget, true, true, false},
        {"KONA", "preparebudget", &preparebudget, true, true, false},
        {"KONA", "submitbudget", &submitbudget, true, true, false},
        {"KONA", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"KONA", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"KONA", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"KONA", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"KONA", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"KONA", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"KONA", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"KONA", "checkbudgets", &checkbudgets, true, true, false},
        {"KONA", "mnsync", &mnsync, true, true, false},
        {"KONA", "spork", &spork, true, true, false},
        {"KONA", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"KONA", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use KONAd, or the -server option to KONA-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> KONA-cli " + methodname + " " + args + "\n";
}
