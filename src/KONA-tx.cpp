...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("KONA Core KONA-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  KONA-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded KONA transaction") + "\n" +
                               "  KONA-tx [options] -create [commands]   " + _("Create hex-encoded KONA transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded KONA transaction
