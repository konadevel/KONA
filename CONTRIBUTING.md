Contributing to KONA Core
============================

The KONA Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KONA Core project, and is not to be
confused with overall KONA Network Protocol consensus changes.

Whether a pull request is merged into KONA Core rests with the project merge
...
Patches that change KONA consensus rules are considerably more involved than
...
Where a patch set proposes to change the KONA consensus, it must have been
...
The project leader is the release manager for each KONA Core release.
